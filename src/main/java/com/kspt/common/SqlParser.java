...
public class SqlParser{
    ...
    public String parseCols(){
       ...
       return cols=getMatchedString(regex,sql);
    }
    ...
    public String parseTables(){
       ...
       return  tables=getMatchedString(regex,sql);
    }
    ...
    public String parseConditions(){
       ...
       return  conditions=getMatchedString(regex,sql);
    }
    ...
    public String parseGroupCols(){
       ...
       return  groupCols=getMatchedString(regex,sql);
    }
    ...
    public String parseOrderCols(){
       ...
       return  orderCols=getMatchedString(regex,sql);
    }
...
//        
        for(String sql:ls){
            System.out.println(new SqlParser(sql).parseTables());
