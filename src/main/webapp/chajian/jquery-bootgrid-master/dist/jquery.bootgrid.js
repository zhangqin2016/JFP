...
;(function ($, window, undefined)
{
    ...
    */
    ...
    Grid.defaults = {
        ...
        labels: {
            all: "全部",
            infos: " {{ctx.start}} 到 {{ctx.end}} 条，共 {{ctx.total}} 条",
            loading: "加载...",
            noResults: "没有找到数据!",
            refresh: "刷新",
            search: "搜索"
        ...
        templates: {
        	...
        	header: "<div id=\"{{ctx.id}}\" class=\"{{css.header}}\"><div class=\"row\"><div id=\"{{ctx.id}}_button\" class=\"col-sm-3\"></div><div class=\"col-sm-9 actionBar\"><p class=\"{{css.search}}\"></p><p class=\"{{css.actions}}\"></p></div></div></div>",
