...
<script type="text/javascript" src="<%=request.getContextPath()%>/zq_js/moxingku/bomoxing/table_list.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/zq_js/tool/pinyin.js"></script>
<title>border</title>
</head>
<body>
<script type="text/javascript">
var ctx="<%= request.getContextPath()%>";
var model_lib_id="${model_lib_id}";
</script>
<div id="grid">
