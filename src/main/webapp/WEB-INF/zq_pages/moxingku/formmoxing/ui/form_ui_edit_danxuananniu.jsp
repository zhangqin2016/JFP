...
<form name="zq_form"  id="zq_form" >
    <div class="formbody">
    <ul class="forminfo">
    <li><label>宽度</label><input check-type="required" id="ui_length"  type="text" class="dfinput" style="width: 50%"  value="${ui_length}" /><i> </i></li>
	<li><label>样式</label> <textarea class="textinput" rows="2"
						style="width: 50%" id='ui_html'>${ui_html}</textarea></li>
    <li><label>单选按钮参数</label><input check-type="required" class="dfinput" type="text" value="${danxuan}" id="danxuan">  </li>
