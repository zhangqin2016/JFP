...
var ctx="<%=request.getContextPath()%>";
		$(function($) {
			...
			$("#save").click(function() {
				...
				var obj = new Object;
				obj.fuxuankuang = $("#fuxuankuang").val();
...
<form name="zq_form" id="zq_form"  >
    ...
    <li><label>样式</label><textarea class="textinput" rows="2" style="width: 50%" id='ui_html'>${ui_html}</textarea>   </li>
    <li><label>复选框参数</label><input class="dfinput" type="text" value="${fuxuankuang}" id="fuxuankuang">  </li>
